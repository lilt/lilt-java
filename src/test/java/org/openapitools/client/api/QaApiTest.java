...
import org.openapitools.client.model.QARuleMatches;
...
public class QaApiTest {
     ...
     */
    @Test
    public void qaCheckTest() throws ApiException {
        String target = null;
        String trglang = null;
        String source = null;
        String srclang = null;
        QARuleMatches response = api.qaCheck(target, trglang, source, srclang);
