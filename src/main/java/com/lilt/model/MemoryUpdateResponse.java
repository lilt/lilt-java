...
public class MemoryUpdateResponse {
  ...
  public MemoryUpdateResponse id(Integer id) {
  ...
  **/
  ...
  public MemoryUpdateResponse numUpdates(Integer numUpdates) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of updates to the Memory.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MemoryUpdateResponse memoryUpdateResponse = (MemoryUpdateResponse) o;
    return Objects.equals(this.id, memoryUpdateResponse.id) &&
        Objects.equals(this.numUpdates, memoryUpdateResponse.numUpdates);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemoryUpdateResponse {\n");
