...
public class ProjectsApi {
    ...
    /**
     * Build call for getProjectRevisionReport
     * @param id A unique Project identifier. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A csv file containing revision report. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Unexpected error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getProjectRevisionReportCall(Integer id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/projects/{id}/revision"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectRevisionReportValidateBeforeCall(Integer id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getProjectRevisionReport(Async)");
        }
        

        okhttp3.Call localVarCall = getProjectRevisionReportCall(id, _callback);
        return localVarCall;
     ...
     */
    public void getProjectRevisionReport(Integer id) throws ApiException {
     ...
     */
    public ApiResponse<Void> getProjectRevisionReportWithHttpInfo(Integer id) throws ApiException {
        okhttp3.Call localVarCall = getProjectRevisionReportValidateBeforeCall(id, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Retrieve Project revision report (asynchronously)
     * Get information about a project&#39;s revision report. This includes: * Stats on accepted segments * reviewer details * Error rate  
     * @param id A unique Project identifier. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getProjectRevisionReportAsync(Integer id, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectRevisionReportValidateBeforeCall(id, _callback);
