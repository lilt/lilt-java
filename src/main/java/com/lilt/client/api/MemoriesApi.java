...
public class MemoriesApi {
     ...
     */
    public okhttp3.Call deleteSegmentFromMemoryCall(Integer id, Integer segmentId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteSegmentFromMemoryValidateBeforeCall(Integer id, Integer segmentId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public DeleteSegmentFromMemoryResponse deleteSegmentFromMemory(Integer id, Integer segmentId) throws ApiException {
     ...
     */
    public ApiResponse<DeleteSegmentFromMemoryResponse> deleteSegmentFromMemoryWithHttpInfo(Integer id, Integer segmentId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteSegmentFromMemoryAsync(Integer id, Integer segmentId, final ApiCallback<DeleteSegmentFromMemoryResponse> _callback) throws ApiException {
