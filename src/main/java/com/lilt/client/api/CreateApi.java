...
public class CreateApi {
     ...
     */
    public okhttp3.Call generateLiltCreateContentCall(LiltCreateContent templateParams, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call generateLiltCreateContentValidateBeforeCall(LiltCreateContent templateParams, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void generateLiltCreateContent(LiltCreateContent templateParams) throws ApiException {
     ...
     */
    public ApiResponse<Void> generateLiltCreateContentWithHttpInfo(LiltCreateContent templateParams) throws ApiException {
     ...
     */
    public okhttp3.Call generateLiltCreateContentAsync(LiltCreateContent templateParams, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public List<LiltCreateContent> getLiltCreateContent() throws ApiException {
        ApiResponse<List<LiltCreateContent>> localVarResp = getLiltCreateContentWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * Get Lilt Create content
     * Get a list of all content that has been generated by Lilt Create.  Example CURL: &#x60;&#x60;&#x60; curl --X --request GET &#39;https://api.lilt.com/v2/create?key&#x3D;API_KEY&#39; &#x60;&#x60;&#x60;  
     * @return ApiResponse&lt;List&lt;LiltCreateContent&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<LiltCreateContent>> getLiltCreateContentWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getLiltCreateContentValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<LiltCreateContent>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getLiltCreateContentAsync(final ApiCallback<List<LiltCreateContent>> _callback) throws ApiException {
