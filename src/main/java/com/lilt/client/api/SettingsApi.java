...
import com.lilt.client.model.SettingDictionary;
...
public class SettingsApi {
     ...
     */
    public SettingDictionary getOrganizationSettings() throws ApiException {
        ApiResponse<SettingDictionary> localVarResp = getOrganizationSettingsWithHttpInfo();
     ...
     * Update or create a setting
     * Get the organization-level settings for the active users organization  Example CURL:  &#x60;&#x60;&#x60; curl --location --request GET &#39;https://lilt.com/2/settings/organization?key&#x3D;&lt;API_KEY&gt;&#39; \\ &#x60;&#x60;&#x60;  
     * @return ApiResponse&lt;SettingDictionary&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SettingDictionary> getOrganizationSettingsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getOrganizationSettingsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<SettingDictionary>(){}.getType();
     ...
     */
    public okhttp3.Call getOrganizationSettingsAsync(final ApiCallback<SettingDictionary> _callback) throws ApiException {
     ...
     */
    public SettingDictionary getProjectSettings(Integer projectId) throws ApiException {
        ApiResponse<SettingDictionary> localVarResp = getProjectSettingsWithHttpInfo(projectId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SettingDictionary> getProjectSettingsWithHttpInfo(Integer projectId) throws ApiException {
     ...
     */
    public okhttp3.Call getProjectSettingsAsync(Integer projectId, final ApiCallback<SettingDictionary> _callback) throws ApiException {
     ...
     */
    public SettingDictionary getUserSettings() throws ApiException {
        ApiResponse<SettingDictionary> localVarResp = getUserSettingsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SettingDictionary> getUserSettingsWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call getUserSettingsAsync(final ApiCallback<SettingDictionary> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call upsertSettingCall(Object body, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertSettingValidateBeforeCall(Object body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Object upsertSetting(Object body) throws ApiException {
        ApiResponse<Object> localVarResp = upsertSettingWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> upsertSettingWithHttpInfo(Object body) throws ApiException {
     ...
     */
    public okhttp3.Call upsertSettingAsync(Object body, final ApiCallback<Object> _callback) throws ApiException {
