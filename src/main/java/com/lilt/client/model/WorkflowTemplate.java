...
public class WorkflowTemplate {
  ...
  **/
  ...
  @ApiModelProperty(example = "15.0", value = "Identifier of a teams Workflow template. Can be used during Job creation for specifying the workflow used for a job or language pair.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.0", value = "The name of a given Workflow template.")
