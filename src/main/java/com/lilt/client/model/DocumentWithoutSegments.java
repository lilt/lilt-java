...
public class DocumentWithoutSegments {
  ...
  public static final String SERIALIZED_NAME_CUSTOMER_REVIEWER_EMAIL = "customer_reviewer_email";
  @SerializedName(SERIALIZED_NAME_CUSTOMER_REVIEWER_EMAIL)
  private String customerReviewerEmail;
  ...
  **/
  ...
  public DocumentWithoutSegments customerReviewerEmail(String customerReviewerEmail) {
    
    this.customerReviewerEmail = customerReviewerEmail;
    return this;
  }

   /**
   * The email of the assigned customer reviewer. Only present if the project was request by id.
   * @return customerReviewerEmail
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "reviewer@example.com", value = "The email of the assigned customer reviewer. Only present if the project was request by id.")

  public String getCustomerReviewerEmail() {
    return customerReviewerEmail;
  }


  public void setCustomerReviewerEmail(String customerReviewerEmail) {
    this.customerReviewerEmail = customerReviewerEmail;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, documentWithoutSegments.id) &&
        ...
        Objects.equals(this.customerReviewerEmail, documentWithoutSegments.customerReviewerEmail) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, projectId, srclang, trglang, name, importInProgress, importSucceeded, importErrorMessage, exportInProgress, exportSucceeded, exportErrorMessage, isPretranslating, status, translatorEmail, reviewerEmail, customerReviewerEmail, createdAt, updatedAt, isReviewComplete);
  }
