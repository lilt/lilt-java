...
public class FilesApi {
     ...
     */
    public java.io.File getFiles(Integer id) throws ApiException {
        ApiResponse<java.io.File> localVarResp = getFilesWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<java.io.File> getFilesWithHttpInfo(Integer id) throws ApiException {
     ...
     */
    public okhttp3.Call getFilesAsync(Integer id, final ApiCallback<java.io.File> _callback) throws ApiException {
