...
public class Example {
  public static void main(String[] args) {
    ...
    Integer id = 56; // Integer | A unique File identifier.
    try {
      List<Object> result = apiInstance.getFiles(id);
      System.out.println(result);
    } catch (ApiException e) {
...
<a name="uploadFile"></a>
# **uploadFile**
> Object uploadFile(name, body, fileHash, langId, projectId, category, labels)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.uploadFile(name, body, fileHash, langId, projectId, category, labels);
      System.out.println(result);
    } catch (ApiException e) {
