...
public class Example {
  public static void main(String[] args) {
    ...
    Integer documentId = 56; // Integer | A unique document identifier.
    try {
      Object result = apiInstance.getDocumentComments(documentId);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer commentId = 56; // Integer | A unique comment identifier.
    Integer documentId = 56; // Integer | A unique document identifier.
    Object body = null; // Object | The comment being updated.
    try {
      Object result = apiInstance.updateComment(commentId, documentId, body);
      System.out.println(result);
    } catch (ApiException e) {
